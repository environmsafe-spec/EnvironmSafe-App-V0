...
const SUITES = ['./app.test', './identity.test', './print.test', './auth.test', './sync.test', './drive.test', './columns.test', './columns2.test', './entity-leak.test', './fx.test', './patch.test', './edit.test', './employee.test', './filters.test']
  .map(m => require(m));
