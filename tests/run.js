...
const SUITES = ['./app.test', './identity.test', './print.test', './auth.test', './sync.test', './drive.test', './columns.test', './columns2.test', './entity-leak.test', './fx.test', './patch.test', './edit.test', './employee.test', './filters.test', './search.test', './addnew.test', './settle.test', './approve.test', './history.test', './complete.test', './close.test']
  .map(m => require(m));
